...
public class TextLabServiceImpl implements TextLabService {
                    ...
                    try {
                        ...
                        chatMemory.add(userId, List.of(
                            ...
                            new AssistantMessage(
                                ...
                                "你可以就这段内容的深层潜台词、意境修辞、心理启迪或创意改写随时向我追问！"
                            )
                        ));
                    } catch (Exception e) {
    ...
    public Flux<String> chatStream(String message, String userId) {
        ...
        return chatClient.prompt()
            .system("""
                你是一个博学、敏锐且善于启发的中文语言、文学与心理情感导师。
                请结合当前对话上下文深入回答用户的追问。无论文本是古典诗词、现代散文、电影台词、流行歌词还是日常心声，均能给出专业、深刻且富有感染力的解读。
